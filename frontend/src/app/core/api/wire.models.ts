...
import type {
  actionApprovalResponseSchema, actionDecisionRequestSchema, actionExecutionRequestSchema, actionExecutionResponseSchema, actionProposalListResponseSchema, actionProposalRequestSchema, actionProposalResponseSchema, actionStatusFilterSchema,
...
export interface AgentActionListFilters { status?: z.input<typeof actionStatusFilterSchema>; actionName?: z.input<typeof actionProposalRequestSchema>['action_name']; requestedBy?: string; limit?: number; cursor?: string; }
