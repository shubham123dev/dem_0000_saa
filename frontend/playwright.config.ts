...
export default defineConfig({
  ...
  use: { baseURL: 'http://127.0.0.1:4201', trace: 'on-first-retry' },
  webServer: { command: 'npm run start', url: 'http://127.0.0.1:4201', reuseExistingServer: !process.env['CI'], timeout: 120000 },
  projects: [
