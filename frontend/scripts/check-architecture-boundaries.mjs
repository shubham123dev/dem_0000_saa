...
const allowedHttpFiles = new Set(['core/api/validated-http.service.ts', 'core/agent-run/agent-run-stream.service.ts', 'core/sse/authenticated-sse-client.service.ts']);
const violations = [];
