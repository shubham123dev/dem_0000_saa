        ...
        definitions = (
            WorkplaceResourceDefinition(
                ...
                fields=(
                    ...
                    _field("environment", "environment", "string", searchable=True, sortable=True),
                    _field("status", "status", "string", searchable=True, sortable=True),
                    _field("version", "version", "integer", searchable=True, sortable=True),
                    _field("created_at", "created_at", "datetime", searchable=True, sortable=True),
                    _field("updated_at", "updated_at", "datetime", searchable=True, sortable=True),
                ),
            ),
            WorkplaceResourceDefinition(
                ...
                fields=(
                    ...
                    _field("is_active", "is_active", "boolean", searchable=True, sortable=True),
                    _field("version", "version", "integer", searchable=True, sortable=True),
                    _field("created_at", "created_at", "datetime", searchable=True, sortable=True),
                    _field("updated_at", "updated_at", "datetime", searchable=True, sortable=True),
                ),
            ...
            WorkplaceResourceDefinition(
                ...
                fields=(
                    ...
                    _field("licensed_modules", "licensed_modules", "integer", searchable=True, sortable=True),
                    _field("available_areas", "available_areas", "integer", searchable=True, sortable=True),
                    _field(
                        "organization_logins",
                        "organization_logins",
                        "integer",
            ...
            WorkplaceResourceDefinition(
                ...
                fields=(
                    ...
                    _field("joined_at", "joined_at", "datetime", nullable=True, searchable=True, sortable=True),
                    _field("version", "version", "integer", searchable=True, sortable=True),
                ),
            ...
            WorkplaceResourceDefinition(
                ...
                fields=(
                    ...
                    _field("total_seats", "total_seats", "integer", searchable=True, sortable=True),
                    _field("status", "status", "string", searchable=True),
                    _field("starts_at", "starts_at", "datetime", nullable=True, searchable=True, sortable=True),
                    _field("expires_at", "expires_at", "datetime", nullable=True, searchable=True, sortable=True),
                    _field("version", "version", "integer", searchable=True, sortable=True),
                ),
                dedicated_management=True,
            ),
            ...
            WorkplaceResourceDefinition(
                ...
                fields=(
                    ...
                    _field("status", "status", "string", searchable=True),
                    _field("granted_at", "granted_at", "datetime", nullable=True, searchable=True, sortable=True),
                    _field("expires_at", "expires_at", "datetime", nullable=True, searchable=True, sortable=True),
                    _field("version", "version", "integer", searchable=True, sortable=True),
                ),
                dedicated_management=True,
